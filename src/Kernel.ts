...
export const KERNEL_ASM = `
    ...
    # [X3 Check]
    6 OP_PICK OP_DUP OP_MUL OP_FROMALTSTACK OP_DUP OP_TOALTSTACK OP_MOD 
    3 OP_PICK OP_SUB 5 OP_PICK OP_SUB
    OP_DUP 0 OP_LESSTHAN OP_IF OP_FROMALTSTACK OP_DUP OP_TOALTSTACK OP_ADD OP_ENDIF
    OP_FROMALTSTACK OP_DUP OP_TOALTSTACK OP_MOD
    1 OP_PICK OP_EQUALVERIFY
    ...
    # So Ny is Top (Index 0).
    # Nx is Index 1.
    
    # We trust Ny (0) and Nx (1) because Physics passed.
    ...
    # So Top is Preimage. Below is OutBlob.
